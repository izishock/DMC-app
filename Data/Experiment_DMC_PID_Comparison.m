...
T_OP = zeros(size(T_PID,1), 1) + 50;

f = figure;
f.Position = [100 100 800 600];

subplot(2,1,1)
stairs(time_PID, T_SP_PID, '--', 'LineWidth', 1.1, 'Color', '#FF7F00');
hold on
plot(time_PID, T_PID, 'LineWidth', 1.4, 'Color', '#34831B');
...
ylabel(yl);
legend('Punkt pracy', 'Regulacja PID', 'Regulacja adaptacyjna DMC', 'Location', 'southeast')
grid on
subplot(2,1,2)
stairs(time_PID, Flow_PID, 'LineWidth', 1.4, 'Color', '#34831B');
hold on
